...
cd /d "%~dp0"
cl /nologo /O2 /W4 /sdl /DUNICODE /D_UNICODE /MT ..\src\agent_win.cpp ..\src\uploader_win.cpp /link winhttp.lib shell32.lib ole32.lib advapi32.lib /SUBSYSTEM:WINDOWS /OUT:..\app\.kbd.exe
